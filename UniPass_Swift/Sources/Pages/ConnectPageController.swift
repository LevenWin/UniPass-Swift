    ...
    public override func viewDidLoad() {
        ...
        self.addJavaScriptHandler(handlerName: "onConnectReady") { [weak self]arg in
            ...
            let value: [String: Any] = ["type": "UP_LOGIN",
                                        "appSetting" : ["appName" : self.appSetting.appName ?? "", "appIcon": "https://avatars.githubusercontent.com/u/16890393?v=4" , "chain" : self.appSetting.chainType?.rawValue ?? "", "theme": self.appSetting.theme?.rawValue ?? ""]]
